                        ...
                        <form action="{{ route('produk.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi_produk" id="deskripsi_produk" cols="30" rows="5"
                                    class='form-control @error('deskripsi_produk') is-invalid @enderror' placeholder="Ketik Keyword Disini"> {{ old('deskripsi_produk') }} </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="diskon" id="diskon"
                                        ...
                                        value="{{ old('diskon') }}" placeholder='0'>
                                    <div class="input-group-append">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="tidakpublish" {{ old('status') === 'tidakpublish' ? 'selected' : '' }}>
