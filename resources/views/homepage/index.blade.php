...
@push('css')
    ...
    @section('content')
        <div class="container-fluid">
            <!-- carousel -->
            <div class="row" >
                <div class="col-4" id="carousel-background">
                    <div class="col" id="jarak">
                        <h1 class="text text-light custom-font" >
                           Halo nama saya ipon
                        </h1>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="col-8" id='carousel-background'>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-auto">
                                            <p>
                                                ...
                                                @endif
                                                <br>
                                                Rp. {{ number_format($ip->harga - ($ip->harga / 100) * $ip->diskon, 2) }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="row mt-4">
                                      ...
                                      <div class="col-auto">
                                          <p>
                                              ...
                                              @else
                                                  <p>
                                                    Rp. {{number_format($iproduk->harga - ($iproduk->diskon/100 * $iproduk->harga), 2)}}
                                                  </p>
                                              @endif
                                          </p>
                                      </div>
